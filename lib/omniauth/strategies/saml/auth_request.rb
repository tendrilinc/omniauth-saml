    ...
    class SAML
      class AuthRequest
        ...
        def create(settings, params = {})
          ...
          unless settings[:authn_context_class_ref].empty? || settings[:authn_context_class_ref].nil?
            request << "<saml:AuthnContextClassRef xmlns:saml=\"urn:oasis:names:tc:SAML:2.0:assertion\">#{settings[:authn_context_class_ref]}</saml:AuthnContextClassRef></samlp:RequestedAuthnContext>\n"
          end
