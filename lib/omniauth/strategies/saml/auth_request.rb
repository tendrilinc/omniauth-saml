    ...
    class SAML
      class AuthRequest
        ...
        def create(settings, params = {})
          ...
          request =
            "<samlp:AuthnRequest #{'ForceAuthn="true"' if settings[:force_authentication]} xmlns:samlp=\"urn:oasis:names:tc:SAML:2.0:protocol\" ID=\"#{uuid}\" Version=\"2.0\" IssueInstant=\"#{time}\" ProtocolBinding=\"urn:oasis:names:tc:SAML:2.0:bindings:HTTP-POST\" AssertionConsumerServiceURL=\"#{settings[:assertion_consumer_service_url]}\">" +
